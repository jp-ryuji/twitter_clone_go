...
type User struct {
	...
	RememberMeTokenExpiresAt    null.Time   `boil:"remember_me_token_expires_at" json:"remember_me_token_expires_at,omitempty" toml:"remember_me_token_expires_at" yaml:"remember_me_token_expires_at,omitempty"`
	...
	ResetPasswordTokenExpiresAt null.Time   `boil:"reset_password_token_expires_at" json:"reset_password_token_expires_at,omitempty" toml:"reset_password_token_expires_at" yaml:"reset_password_token_expires_at,omitempty"`
	ResetPasswordEmailSentAt    null.Time   `boil:"reset_password_email_sent_at" json:"reset_password_email_sent_at,omitempty" toml:"reset_password_email_sent_at" yaml:"reset_password_email_sent_at,omitempty"`
...
var UserWhere = struct {
	...
	CryptedPassword:             whereHelpernull_String{field: "\"users\".\"crypted_password\""},
	Salt:                        whereHelpernull_String{field: "\"users\".\"salt\""},
	CreatedAt:                   whereHelpertime_Time{field: "\"users\".\"created_at\""},
	UpdatedAt:                   whereHelpertime_Time{field: "\"users\".\"updated_at\""},
	RememberMeToken:             whereHelpernull_String{field: "\"users\".\"remember_me_token\""},
	RememberMeTokenExpiresAt:    whereHelpernull_Time{field: "\"users\".\"remember_me_token_expires_at\""},
	ResetPasswordToken:          whereHelpernull_String{field: "\"users\".\"reset_password_token\""},
	ResetPasswordTokenExpiresAt: whereHelpernull_Time{field: "\"users\".\"reset_password_token_expires_at\""},
	ResetPasswordEmailSentAt:    whereHelpernull_Time{field: "\"users\".\"reset_password_email_sent_at\""},
	Name:                        whereHelpernull_String{field: "\"users\".\"name\""},
	ScreenName:                  whereHelperstring{field: "\"users\".\"screen_name\""},
	Code:                        whereHelpernull_String{field: "\"users\".\"code\""},
}
...
var (
	userAllColumns            = []string{"id", "email", "crypted_password", "salt", "created_at", "updated_at", "remember_me_token", "remember_me_token_expires_at", "reset_password_token", "reset_password_token_expires_at", "reset_password_email_sent_at", "name", "screen_name", "code"}
	userColumnsWithoutDefault = []string{"email", "crypted_password", "salt", "created_at", "updated_at", "remember_me_token", "remember_me_token_expires_at", "reset_password_token", "reset_password_token_expires_at", "reset_password_email_sent_at", "name", "screen_name", "code"}
...
func (userL) LoadPosts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`posts`), qm.WhereIn(`user_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
