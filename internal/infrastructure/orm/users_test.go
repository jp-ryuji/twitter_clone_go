...
func testUserToManySetOpPosts(t *testing.T) {
	var err error
...
func testUserToManyRemoveOpPosts(t *testing.T) {
	var err error
...
var (
	userDBTypes = map[string]string{`ID`: `bigint`, `Email`: `character varying`, `CryptedPassword`: `character varying`, `Salt`: `character varying`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`, `RememberMeToken`: `character varying`, `RememberMeTokenExpiresAt`: `timestamp without time zone`, `ResetPasswordToken`: `character varying`, `ResetPasswordTokenExpiresAt`: `timestamp without time zone`, `ResetPasswordEmailSentAt`: `timestamp without time zone`, `Name`: `character varying`, `ScreenName`: `character varying`, `Code`: `character varying`}
	_           = bytes.MinRead
)
