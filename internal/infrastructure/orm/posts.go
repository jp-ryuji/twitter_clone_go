...
var PostWhere = struct {
	...
	UserID:    whereHelpernull_Int64{field: "\"posts\".\"user_id\""},
	...
	IDToken:   whereHelperstring{field: "\"posts\".\"id_token\""},
}
...
var (
	postAllColumns            = []string{"id", "user_id", "content", "created_at", "updated_at", "id_token"}
	postColumnsWithoutDefault = []string{"user_id", "content", "created_at", "updated_at", "id_token"}
