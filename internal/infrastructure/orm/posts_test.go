...
var (
	postDBTypes = map[string]string{`ID`: `bigint`, `UserID`: `bigint`, `Content`: `text`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`, `IDToken`: `character varying`}
	_           = bytes.MinRead
)
